...
![Last Checked](https://img.shields.io/badge/Last_Ping-2026--09--14_16:51:30_IST-informational)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **tiny-to (Web & Database)** | `PRODUCTION` | `GET` | `Web Applications` | 🟢 Healthy | `Every 5m` | `100.0%` | `200` | `851.46ms` | SSL: 74d left | Keeps Tiny-To database query engine & Vercel serverless function warm | - |

---

## 🕒 Last Sync

- **Timestamp**: `2026-09-14 16:51:30 IST`
